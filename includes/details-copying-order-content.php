<section class="row copy-order-details">
        <div class="col starts-at-full clr holding-box">
            ...
            <div class="breather avoid-breaking">
                <h2 class="inline">Order reference number: RC1000001</h2>
                    ...
                    <div class="responsive-table">
                        <table>
                            ...
                            <tr>
                                ...
                                <td>Record copying order suspended</td>
                            </tr>
                            <tr>
                ...
                <div class="dashboard-component">
                    <h3 class="inline">Delivery type: Collect in person</h3>
                    <div class="responsive-table">
                        <table>
                            <tbody>
                            <tr>
                ...
                <div class="holds-columns-together">
                    ...
                    <form action="#" method="post"><input id="Id" name="Id" type="hidden" value="RC1000001" />
                        <a href="suspended-order-history.php" class="abandon-link">History</a>
                        <input type="submit" value="Release suspended job">
                    </form>
                    </div>
                </div>
            </div>
